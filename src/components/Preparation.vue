...
function getProfessionColumnResult(index_division, index_chapter) {
    ...
    let arr_column = ['to1', 'indt', 'tren', 'exam', 'to2', 'po', 'count_people', 'per'];
            ...
            <table class="table">
                ...
                <tbody v-for="(division, index_division) in plan" :key="index_division">
                    ...
                    <tr>
                        ...
                        <td :rowspan="profession.code.length+1"><input type="number" class="input_text" v-model="profession.per" @change="getProfessionColumnResult(index_division, index_chapter)"></td>
                    ...
                    <tr>
                        ...
                        <td>{{ chapter.arr_profession_results['per'] }}</td>
                    ...
                    <tr>
                        ...
                        <td>{{ division.arr_chapter_results['per'] }}</td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ final.arr_plan_result['per'] }}</td>
