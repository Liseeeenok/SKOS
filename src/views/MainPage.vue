...
<template>
    <div class="wrapper">
        ...
        <template v-if="admin.menu == 4 && admin.menuStatus == 'statementView'"><Statement/></template>
        <template v-if="admin.menu == 4 && admin.menuStatus == 'statementEdit'"><StatementEdit/></template>
    </div>
</template>
